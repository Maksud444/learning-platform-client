        ...
        <div className='grid grid-cols-1 md:grid-cols-2 px-5'>
             <div className="card w-96 bg-base-100 shadow-xl mb-5">
               <figure className="px-10 pt-10">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRYpzZMYoh4ok4ZAjAuH-o5OjLQAm7wyvogQ&usqp=CAU" alt="Shoes" className="rounded-xl" />
               </figure>
            <div className="card-body items-center text-center">
             ...
             <div className="card w-96 bg-base-100 shadow-xl mb-5">
               <figure className="px-10 pt-10">
                  <img src="https://blog.codemagic.io/uploads/covers/codemagic-blog-flutter-web-firebase-authentication-and-google-sign-in.png" alt="Shoes" className="rounded-xl" />
               </figure>
            <div className="card-body items-center text-center">
             ...
             <div className="card w-96 bg-base-100 shadow-xl mb-5">
               <figure className="px-10 pt-10">
                  <img src="https://crowdbotics.ghost.io/content/images/2019/07/react-router.jpg" alt="Shoes" className="rounded-xl" />
               </figure>
            <div className="card-body items-center text-center">
